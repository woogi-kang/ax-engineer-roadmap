...
- [역할 선택 안내](../start-here/persona-selector.md)에서 주 트랙과 협업 트랙을 고른다.
...
다섯 [증거 중심 프로젝트](../projects/README.md)는 이 12주 경로의 통과 지점을 제공한다. 1~4주에는 안전한 보조 도구, 5~6주에는 사람 승인과 샌드박스 통합, 7~8주에는 운영 파일럿 또는 시뮬레이션, 9~12주에는 두 번째 업무 재사용 증거를 만든다.
