...
[조직 준비도 진단](../start-here/organization-readiness.md)은 특정 업무를 지금 어떤 방식으로 시작할 수 있는지 본다. 이 문서의 성숙도는 여러 업무에서 운영 능력이 얼마나 반복되는지 본다. 준비도가 높은 한 업무가 있다고 조직 전체의 성숙도가 높은 것은 아니다.
...
| 평가 | 주관적 확인 | 업무별 사례 | 회귀·운영 평가 | 공통 평가 기준 | 실패가 표준을 개선 |
| 통제 | 개인 판단 | 금지선 | 권한·감사·복구 | 중앙 정책과 팀 경계 | 위험 기반 지속 조정 |
| 현업 정착 | 자발적 사용 | 제한 사용자 | 공식 절차와 인수인계 | 교육·지원·자립 | 역할과 절차 지속 개선 |
