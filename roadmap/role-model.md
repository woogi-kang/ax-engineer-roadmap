...
AX Engineer가 모든 결정을 혼자 내리는 것은 아니다. 업무 책임자, 데이터 소유자, 보안·법무 담당자, 기존 시스템 운영자와 함께 판단한다. AX Engineer는 이 결정이 구현과 운영 기록으로 이어지게 할 책임을 맡는다.
...
한 직무가 세 축을 모두 깊게 맡아야 하는 것은 아니다. 다만 한 업무를 운영에 배포하려면 각 책임을 누가 맡는지 설명할 수 있어야 한다.
