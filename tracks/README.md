...
이 로드맵의 주 독자는 AX 엔지니어지만, 한 업무를 AX로 전환하려면 현업·리더·데이터·보안·운영 담당자와 함께 결정해야 한다. 여기서는 AX 엔지니어의 실행 경로와 세 협업 역할의 책임을 나눠 설명한다.

## 모든 역할이 알아야 할 기본 사항

역할은 달라도 다음 사항은 함께 판단한다.
...
| [현업 실무자](business-practitioner.md) | 업무 정의, 검수, 예외, SOP, 현업 정착 | 현재와 목표 업무 흐름, 검수 기준, 사용자 검수, SOP |
